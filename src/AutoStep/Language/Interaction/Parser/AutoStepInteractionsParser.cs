...
internal partial class AutoStepInteractionsParser : Parser {
	...
	public const int
		...
		RULE_methodStr = 14, RULE_methodStrPart = 15, RULE_componentDefinition = 16, 
		RULE_componentItem = 17, RULE_stepDefinitionBody = 18, RULE_stepDefinition = 19, 
		RULE_stepDeclaration = 20, RULE_stepDeclarationBody = 21, RULE_stepDeclarationSection = 22, 
		RULE_stepDeclarationArgument = 23, RULE_stepDeclarationArgumentName = 24, 
		RULE_stepDeclarationTypeHint = 25, RULE_stepDeclarationSectionContent = 26;
	public static readonly string[] ruleNames = {
		...
		"methodStr", "methodStrPart", "componentDefinition", "componentItem", 
		"stepDefinitionBody", "stepDefinition", "stepDeclaration", "stepDeclarationBody", 
		"stepDeclarationSection", "stepDeclarationArgument", "stepDeclarationArgumentName", 
		"stepDeclarationTypeHint", "stepDeclarationSectionContent"
	};
	...
	public EntityDefinitionContext entityDefinition() {
		...
		try {
			...
			case TRAIT_DEFINITION:
				EnterOuterAlt(_localctx, 1);
				{
				State = 62; traitDefinition();
				}
				break;
			case COMPONENT_DEFINITION:
				EnterOuterAlt(_localctx, 2);
				{
				State = 63; componentDefinition();
				}
				break;
			case APP_DEFINITION:
				EnterOuterAlt(_localctx, 3);
				{
				State = 64; appDefinition();
				}
				break;
			default:
	...
	public AppItemContext appItem() {
		...
		try {
			...
			case COMPONENTS_KEYWORD:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 77; Match(COMPONENTS_KEYWORD);
	...
	public TraitDefinitionContext traitDefinition() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 90; Match(TRAIT_DEFINITION);
			State = 91; traitRefList();
			State = 95;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
	...
	public MethodDefinitionContext methodDefinition() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 112; methodDeclaration();
			State = 113; Match(DEF_SEPARATOR);
			State = 116;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case NEEDS_DEFINING:
				{
				State = 114; Match(NEEDS_DEFINING);
				}
				break;
			case NAME_REF:
				{
				State = 115; methodCallChain();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public MethodDeclarationContext methodDeclaration() {
		...
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 118; Match(NAME_REF);
			State = 119; Match(METHOD_OPEN);
			State = 121;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==PARAM_NAME) {
				{
				State = 120; methodDefArgs();
				}
			}

			State = 123; Match(METHOD_CLOSE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public MethodDefArgsContext methodDefArgs() {
		...
		try {
			...
			while (_la==PARAM_SEPARATOR) {
				{
				{
				State = 126; Match(PARAM_SEPARATOR);
	...
	public MethodCallChainContext methodCallChain() {
		...
		try {
			...
			while (_la==FUNC_PASS_MARKER) {
				{
				{
				State = 134; Match(FUNC_PASS_MARKER);
	...
	public MethodStrContext methodStr() {
		...
		EnterRule(_localctx, 28, RULE_methodStr);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public MethodStrPartContext methodStrPart() {
		...
		EnterRule(_localctx, 30, RULE_methodStrPart);
		try {
			State = 187;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
	...
	public ComponentDefinitionContext componentDefinition() {
		...
		EnterRule(_localctx, 32, RULE_componentDefinition);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
	...
	public ComponentItemContext componentItem() {
		...
		EnterRule(_localctx, 34, RULE_componentItem);
		int _la;
		try {
			State = 212;
			ErrorHandler.Sync(this);
			...
			case INHERITS_KEYWORD:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 199; Match(INHERITS_KEYWORD);
				State = 200; Match(NAME_REF);
				}
				break;
			case TRAITS_KEYWORD:
				...
				EnterOuterAlt(_localctx, 3);
				{
				State = 201; Match(TRAITS_KEYWORD);
				State = 202; Match(NAME_REF);
				State = 207;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				while (_la==LIST_SEPARATOR) {
					{
					{
					State = 203; Match(LIST_SEPARATOR);
	...
	public StepDefinitionBodyContext stepDefinitionBody() {
		...
		EnterRule(_localctx, 36, RULE_stepDefinitionBody);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 214; stepDefinition();
			State = 215; methodCall();
			State = 220;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (_la==FUNC_PASS_MARKER) {
				{
				{
				State = 216; Match(FUNC_PASS_MARKER);
				State = 217; methodCall();
				}
				}
				State = 222;
				ErrorHandler.Sync(this);
	...
	public StepDefinitionContext stepDefinition() {
		...
		EnterRule(_localctx, 38, RULE_stepDefinition);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 223; Match(STEP_DEFINE);
			State = 225;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==DEF_WS) {
				{
				State = 224; Match(DEF_WS);
				}
			}

			State = 227; stepDeclaration();
			State = 228; Match(DEF_NEWLINE);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public StepDeclarationContext stepDeclaration() {
		...
		EnterRule(_localctx, 40, RULE_stepDeclaration);
		try {
			State = 245;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
	...
	public StepDeclarationBodyContext stepDeclarationBody() {
		...
		EnterRule(_localctx, 42, RULE_stepDeclarationBody);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			...
			do {
				{
				{
				State = 247; stepDeclarationSection();
				}
				}
				State = 250;
				ErrorHandler.Sync(this);
	...
	public StepDeclarationSectionContext stepDeclarationSection() {
		...
		EnterRule(_localctx, 44, RULE_stepDeclarationSection);
		try {
			State = 257;
			ErrorHandler.Sync(this);
			switch (TokenStream.LA(1)) {
			case DEF_LCURLY:
				...
				EnterOuterAlt(_localctx, 1);
				{
				State = 252; Match(DEF_LCURLY);
				State = 253; stepDeclarationArgument();
				State = 254; Match(DEF_RCURLY);
				}
				break;
			case DEF_GIVEN:
			case DEF_WHEN:
			...
			case DEF_WORD:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 256; stepDeclarationSectionContent();
				}
				break;
			default:
				throw new NoViableAltException(this);
	...
	public StepDeclarationArgumentContext stepDeclarationArgument() {
		...
		EnterRule(_localctx, 46, RULE_stepDeclarationArgument);
		int _la;
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 259; stepDeclarationArgumentName();
			State = 262;
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			if (_la==DEF_COLON) {
				{
				State = 260; Match(DEF_COLON);
				State = 261; stepDeclarationTypeHint();
				}
			}
	...
	public StepDeclarationArgumentNameContext stepDeclarationArgumentName() {
		...
		EnterRule(_localctx, 48, RULE_stepDeclarationArgumentName);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 264; Match(DEF_WORD);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public StepDeclarationTypeHintContext stepDeclarationTypeHint() {
		...
		EnterRule(_localctx, 50, RULE_stepDeclarationTypeHint);
		try {
			EnterOuterAlt(_localctx, 1);
			{
			State = 266; Match(DEF_WORD);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public StepDeclarationSectionContentContext stepDeclarationSectionContent() {
		...
		EnterRule(_localctx, 52, RULE_stepDeclarationSectionContent);
		int _la;
		try {
			State = 273;
			ErrorHandler.Sync(this);
			...
			case DEF_COMPONENT_INSERT:
				...
				EnterOuterAlt(_localctx, 2);
				{
				State = 269; Match(DEF_COMPONENT_INSERT);
				}
				break;
			case DEF_ESCAPED_LCURLY:
			case DEF_ESCAPED_RCURLY:
	...
	private static char[] _serializedATN = {
		...
		'\x5964', '\x3', '\x39', '\x116', '\x4', '\x2', '\t', '\x2', '\x4', '\x3', 
		...
		'\x5', '\x3', '\x5', '\a', '\x5', 'T', '\n', '\x5', '\f', '\x5', '\xE', 
		'\x5', 'W', '\v', '\x5', '\x3', '\x5', '\x3', '\x5', '\x5', '\x5', '[', 
		'\n', '\x5', '\x3', '\x6', '\x3', '\x6', '\x3', '\x6', '\a', '\x6', '`', 
		'\n', '\x6', '\f', '\x6', '\xE', '\x6', '\x63', '\v', '\x6', '\x3', '\a', 
		'\x3', '\a', '\x3', '\a', '\a', '\a', 'h', '\n', '\a', '\f', '\a', '\xE', 
		'\a', 'k', '\v', '\a', '\x3', '\b', '\x3', '\b', '\x3', '\b', '\x3', '\b', 
		'\x5', '\b', 'q', '\n', '\b', '\x3', '\t', '\x3', '\t', '\x3', '\t', '\x3', 
		'\t', '\x5', '\t', 'w', '\n', '\t', '\x3', '\n', '\x3', '\n', '\x3', '\n', 
		'\x5', '\n', '|', '\n', '\n', '\x3', '\n', '\x3', '\n', '\x3', '\v', '\x3', 
		'\v', '\x3', '\v', '\a', '\v', '\x83', '\n', '\v', '\f', '\v', '\xE', 
		'\v', '\x86', '\v', '\v', '\x3', '\f', '\x3', '\f', '\x3', '\f', '\a', 
		'\f', '\x8B', '\n', '\f', '\f', '\f', '\xE', '\f', '\x8E', '\v', '\f', 
		'\x3', '\r', '\x3', '\r', '\x3', '\r', '\x5', '\r', '\x93', '\n', '\r', 
		'\x3', '\r', '\x3', '\r', '\x3', '\xE', '\x3', '\xE', '\x3', '\xE', '\a', 
		'\xE', '\x9A', '\n', '\xE', '\f', '\xE', '\xE', '\xE', '\x9D', '\v', '\xE', 
		'\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', 
		'\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', 
		'\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', 
		'\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x3', '\xF', '\x5', '\xF', 
		'\xB2', '\n', '\xF', '\x3', '\x10', '\x6', '\x10', '\xB5', '\n', '\x10', 
		'\r', '\x10', '\xE', '\x10', '\xB6', '\x3', '\x11', '\x3', '\x11', '\x3', 
		'\x11', '\x3', '\x11', '\x3', '\x11', '\x5', '\x11', '\xBE', '\n', '\x11', 
		'\x3', '\x12', '\x3', '\x12', '\x3', '\x12', '\a', '\x12', '\xC3', '\n', 
		'\x12', '\f', '\x12', '\xE', '\x12', '\xC6', '\v', '\x12', '\x3', '\x13', 
		'\x3', '\x13', '\x3', '\x13', '\x3', '\x13', '\x3', '\x13', '\x3', '\x13', 
		'\x3', '\x13', '\x3', '\x13', '\a', '\x13', '\xD0', '\n', '\x13', '\f', 
		'\x13', '\xE', '\x13', '\xD3', '\v', '\x13', '\x3', '\x13', '\x3', '\x13', 
		'\x5', '\x13', '\xD7', '\n', '\x13', '\x3', '\x14', '\x3', '\x14', '\x3', 
		'\x14', '\x3', '\x14', '\a', '\x14', '\xDD', '\n', '\x14', '\f', '\x14', 
		'\xE', '\x14', '\xE0', '\v', '\x14', '\x3', '\x15', '\x3', '\x15', '\x5', 
		...
		'\x6', '\x17', '\xFB', '\n', '\x17', '\r', '\x17', '\xE', '\x17', '\xFC', 
		'\x3', '\x18', '\x3', '\x18', '\x3', '\x18', '\x3', '\x18', '\x3', '\x18', 
		'\x5', '\x18', '\x104', '\n', '\x18', '\x3', '\x19', '\x3', '\x19', '\x3', 
		'\x19', '\x5', '\x19', '\x109', '\n', '\x19', '\x3', '\x1A', '\x3', '\x1A', 
		'\x3', '\x1B', '\x3', '\x1B', '\x3', '\x1C', '\x3', '\x1C', '\x3', '\x1C', 
		'\x3', '\x1C', '\x3', '\x1C', '\x5', '\x1C', '\x114', '\n', '\x1C', '\x3', 
		'\x1C', '\x2', '\x2', '\x1D', '\x2', '\x4', '\x6', '\b', '\n', '\f', '\xE', 
		'\x10', '\x12', '\x14', '\x16', '\x18', '\x1A', '\x1C', '\x1E', ' ', '\"', 
		'$', '&', '(', '*', ',', '.', '\x30', '\x32', '\x34', '\x36', '\x2', '\x4', 
		'\x4', '\x2', '+', '-', '\x36', '\x36', '\x3', '\x2', '.', '/', '\x2', 
		'\x129', '\x2', ';', '\x3', '\x2', '\x2', '\x2', '\x4', '\x43', '\x3', 
		'\x2', '\x2', '\x2', '\x6', '\x45', '\x3', '\x2', '\x2', '\x2', '\b', 
		'Z', '\x3', '\x2', '\x2', '\x2', '\n', '\\', '\x3', '\x2', '\x2', '\x2', 
		'\f', '\x64', '\x3', '\x2', '\x2', '\x2', '\xE', 'p', '\x3', '\x2', '\x2', 
		'\x2', '\x10', 'r', '\x3', '\x2', '\x2', '\x2', '\x12', 'x', '\x3', '\x2', 
		'\x2', '\x2', '\x14', '\x7F', '\x3', '\x2', '\x2', '\x2', '\x16', '\x87', 
		'\x3', '\x2', '\x2', '\x2', '\x18', '\x8F', '\x3', '\x2', '\x2', '\x2', 
		'\x1A', '\x96', '\x3', '\x2', '\x2', '\x2', '\x1C', '\xB1', '\x3', '\x2', 
		'\x2', '\x2', '\x1E', '\xB4', '\x3', '\x2', '\x2', '\x2', ' ', '\xBD', 
		'\x3', '\x2', '\x2', '\x2', '\"', '\xBF', '\x3', '\x2', '\x2', '\x2', 
		'$', '\xD6', '\x3', '\x2', '\x2', '\x2', '&', '\xD8', '\x3', '\x2', '\x2', 
		'\x2', '(', '\xE1', '\x3', '\x2', '\x2', '\x2', '*', '\xF7', '\x3', '\x2', 
		'\x2', '\x2', ',', '\xFA', '\x3', '\x2', '\x2', '\x2', '.', '\x103', '\x3', 
		'\x2', '\x2', '\x2', '\x30', '\x105', '\x3', '\x2', '\x2', '\x2', '\x32', 
		'\x10A', '\x3', '\x2', '\x2', '\x2', '\x34', '\x10C', '\x3', '\x2', '\x2', 
		'\x2', '\x36', '\x113', '\x3', '\x2', '\x2', '\x2', '\x38', ':', '\x5', 
		'\x4', '\x3', '\x2', '\x39', '\x38', '\x3', '\x2', '\x2', '\x2', ':', 
		'=', '\x3', '\x2', '\x2', '\x2', ';', '\x39', '\x3', '\x2', '\x2', '\x2', 
		';', '<', '\x3', '\x2', '\x2', '\x2', '<', '>', '\x3', '\x2', '\x2', '\x2', 
		'=', ';', '\x3', '\x2', '\x2', '\x2', '>', '?', '\a', '\x2', '\x2', '\x3', 
		'?', '\x3', '\x3', '\x2', '\x2', '\x2', '@', '\x44', '\x5', '\n', '\x6', 
		'\x2', '\x41', '\x44', '\x5', '\"', '\x12', '\x2', '\x42', '\x44', '\x5', 
		'\x6', '\x4', '\x2', '\x43', '@', '\x3', '\x2', '\x2', '\x2', '\x43', 
		'\x41', '\x3', '\x2', '\x2', '\x2', '\x43', '\x42', '\x3', '\x2', '\x2', 
		'\x2', '\x44', '\x5', '\x3', '\x2', '\x2', '\x2', '\x45', '\x46', '\a', 
		'\x3', '\x2', '\x2', '\x46', 'J', '\a', '\x10', '\x2', '\x2', 'G', 'I', 
		'\x5', '\b', '\x5', '\x2', 'H', 'G', '\x3', '\x2', '\x2', '\x2', 'I', 
		'L', '\x3', '\x2', '\x2', '\x2', 'J', 'H', '\x3', '\x2', '\x2', '\x2', 
		'J', 'K', '\x3', '\x2', '\x2', '\x2', 'K', '\a', '\x3', '\x2', '\x2', 
		'\x2', 'L', 'J', '\x3', '\x2', '\x2', '\x2', 'M', 'N', '\a', '\b', '\x2', 
		'\x2', 'N', '[', '\a', '\x14', '\x2', '\x2', 'O', 'P', '\a', '\t', '\x2', 
		'\x2', 'P', 'U', '\a', '\x10', '\x2', '\x2', 'Q', 'R', '\a', '\f', '\x2', 
		'\x2', 'R', 'T', '\a', '\x10', '\x2', '\x2', 'S', 'Q', '\x3', '\x2', '\x2', 
		'\x2', 'T', 'W', '\x3', '\x2', '\x2', '\x2', 'U', 'S', '\x3', '\x2', '\x2', 
		'\x2', 'U', 'V', '\x3', '\x2', '\x2', '\x2', 'V', '[', '\x3', '\x2', '\x2', 
		'\x2', 'W', 'U', '\x3', '\x2', '\x2', '\x2', 'X', '[', '\x5', '\x10', 
		'\t', '\x2', 'Y', '[', '\x5', '&', '\x14', '\x2', 'Z', 'M', '\x3', '\x2', 
		'\x2', '\x2', 'Z', 'O', '\x3', '\x2', '\x2', '\x2', 'Z', 'X', '\x3', '\x2', 
		'\x2', '\x2', 'Z', 'Y', '\x3', '\x2', '\x2', '\x2', '[', '\t', '\x3', 
		'\x2', '\x2', '\x2', '\\', ']', '\a', '\x4', '\x2', '\x2', ']', '\x61', 
		'\x5', '\f', '\a', '\x2', '^', '`', '\x5', '\xE', '\b', '\x2', '_', '^', 
		'\x3', '\x2', '\x2', '\x2', '`', '\x63', '\x3', '\x2', '\x2', '\x2', '\x61', 
		'_', '\x3', '\x2', '\x2', '\x2', '\x61', '\x62', '\x3', '\x2', '\x2', 
		'\x2', '\x62', '\v', '\x3', '\x2', '\x2', '\x2', '\x63', '\x61', '\x3', 
		'\x2', '\x2', '\x2', '\x64', 'i', '\a', '\x10', '\x2', '\x2', '\x65', 
		'\x66', '\a', '\x11', '\x2', '\x2', '\x66', 'h', '\a', '\x10', '\x2', 
		'\x2', 'g', '\x65', '\x3', '\x2', '\x2', '\x2', 'h', 'k', '\x3', '\x2', 
		'\x2', '\x2', 'i', 'g', '\x3', '\x2', '\x2', '\x2', 'i', 'j', '\x3', '\x2', 
		'\x2', '\x2', 'j', '\r', '\x3', '\x2', '\x2', '\x2', 'k', 'i', '\x3', 
		'\x2', '\x2', '\x2', 'l', 'm', '\a', '\b', '\x2', '\x2', 'm', 'q', '\a', 
		'\x14', '\x2', '\x2', 'n', 'q', '\x5', '\x10', '\t', '\x2', 'o', 'q', 
		'\x5', '&', '\x14', '\x2', 'p', 'l', '\x3', '\x2', '\x2', '\x2', 'p', 
		'n', '\x3', '\x2', '\x2', '\x2', 'p', 'o', '\x3', '\x2', '\x2', '\x2', 
		'q', '\xF', '\x3', '\x2', '\x2', '\x2', 'r', 's', '\x5', '\x12', '\n', 
		'\x2', 's', 'v', '\a', '\r', '\x2', '\x2', 't', 'w', '\a', '\xE', '\x2', 
		'\x2', 'u', 'w', '\x5', '\x16', '\f', '\x2', 'v', 't', '\x3', '\x2', '\x2', 
		'\x2', 'v', 'u', '\x3', '\x2', '\x2', '\x2', 'w', '\x11', '\x3', '\x2', 
		'\x2', '\x2', 'x', 'y', '\a', '\x10', '\x2', '\x2', 'y', '{', '\a', '\xF', 
		'\x2', '\x2', 'z', '|', '\x5', '\x14', '\v', '\x2', '{', 'z', '\x3', '\x2', 
		'\x2', '\x2', '{', '|', '\x3', '\x2', '\x2', '\x2', '|', '}', '\x3', '\x2', 
		'\x2', '\x2', '}', '~', '\a', '\"', '\x2', '\x2', '~', '\x13', '\x3', 
		'\x2', '\x2', '\x2', '\x7F', '\x84', '\a', '\x1C', '\x2', '\x2', '\x80', 
		'\x81', '\a', '\x1F', '\x2', '\x2', '\x81', '\x83', '\a', '\x1C', '\x2', 
		'\x2', '\x82', '\x80', '\x3', '\x2', '\x2', '\x2', '\x83', '\x86', '\x3', 
		'\x2', '\x2', '\x2', '\x84', '\x82', '\x3', '\x2', '\x2', '\x2', '\x84', 
		'\x85', '\x3', '\x2', '\x2', '\x2', '\x85', '\x15', '\x3', '\x2', '\x2', 
		'\x2', '\x86', '\x84', '\x3', '\x2', '\x2', '\x2', '\x87', '\x8C', '\x5', 
		'\x18', '\r', '\x2', '\x88', '\x89', '\a', '\x13', '\x2', '\x2', '\x89', 
		'\x8B', '\x5', '\x18', '\r', '\x2', '\x8A', '\x88', '\x3', '\x2', '\x2', 
		'\x2', '\x8B', '\x8E', '\x3', '\x2', '\x2', '\x2', '\x8C', '\x8A', '\x3', 
		'\x2', '\x2', '\x2', '\x8C', '\x8D', '\x3', '\x2', '\x2', '\x2', '\x8D', 
		'\x17', '\x3', '\x2', '\x2', '\x2', '\x8E', '\x8C', '\x3', '\x2', '\x2', 
		'\x2', '\x8F', '\x90', '\a', '\x10', '\x2', '\x2', '\x90', '\x92', '\a', 
		'\xF', '\x2', '\x2', '\x91', '\x93', '\x5', '\x1A', '\xE', '\x2', '\x92', 
		'\x91', '\x3', '\x2', '\x2', '\x2', '\x92', '\x93', '\x3', '\x2', '\x2', 
		'\x2', '\x93', '\x94', '\x3', '\x2', '\x2', '\x2', '\x94', '\x95', '\a', 
		'\"', '\x2', '\x2', '\x95', '\x19', '\x3', '\x2', '\x2', '\x2', '\x96', 
		'\x9B', '\x5', '\x1C', '\xF', '\x2', '\x97', '\x98', '\a', '\x1F', '\x2', 
		'\x2', '\x98', '\x9A', '\x5', '\x1C', '\xF', '\x2', '\x99', '\x97', '\x3', 
		'\x2', '\x2', '\x2', '\x9A', '\x9D', '\x3', '\x2', '\x2', '\x2', '\x9B', 
		'\x99', '\x3', '\x2', '\x2', '\x2', '\x9B', '\x9C', '\x3', '\x2', '\x2', 
		'\x2', '\x9C', '\x1B', '\x3', '\x2', '\x2', '\x2', '\x9D', '\x9B', '\x3', 
		'\x2', '\x2', '\x2', '\x9E', '\x9F', '\a', '\x1A', '\x2', '\x2', '\x9F', 
		'\xA0', '\x5', '\x1E', '\x10', '\x2', '\xA0', '\xA1', '\a', '&', '\x2', 
		'\x2', '\xA1', '\xB2', '\x3', '\x2', '\x2', '\x2', '\xA2', '\xB2', '\a', 
		'\x1C', '\x2', '\x2', '\xA3', '\xA4', '\a', '\x1C', '\x2', '\x2', '\xA4', 
		'\xA5', '\a', '\x1D', '\x2', '\x2', '\xA5', '\xA6', '\a', '\x1C', '\x2', 
		'\x2', '\xA6', '\xB2', '\a', '\x1E', '\x2', '\x2', '\xA7', '\xA8', '\a', 
		'\x1C', '\x2', '\x2', '\xA8', '\xA9', '\a', '\x1D', '\x2', '\x2', '\xA9', 
		'\xAA', '\a', '\x1A', '\x2', '\x2', '\xAA', '\xAB', '\x5', '\x1E', '\x10', 
		'\x2', '\xAB', '\xAC', '\a', '&', '\x2', '\x2', '\xAC', '\xAD', '\a', 
		'\x1E', '\x2', '\x2', '\xAD', '\xB2', '\x3', '\x2', '\x2', '\x2', '\xAE', 
		'\xB2', '\a', '\x1B', '\x2', '\x2', '\xAF', '\xB2', '\a', '!', '\x2', 
		'\x2', '\xB0', '\xB2', '\a', ' ', '\x2', '\x2', '\xB1', '\x9E', '\x3', 
		'\x2', '\x2', '\x2', '\xB1', '\xA2', '\x3', '\x2', '\x2', '\x2', '\xB1', 
		'\xA3', '\x3', '\x2', '\x2', '\x2', '\xB1', '\xA7', '\x3', '\x2', '\x2', 
		'\x2', '\xB1', '\xAE', '\x3', '\x2', '\x2', '\x2', '\xB1', '\xAF', '\x3', 
		'\x2', '\x2', '\x2', '\xB1', '\xB0', '\x3', '\x2', '\x2', '\x2', '\xB2', 
		'\x1D', '\x3', '\x2', '\x2', '\x2', '\xB3', '\xB5', '\x5', ' ', '\x11', 
		'\x2', '\xB4', '\xB3', '\x3', '\x2', '\x2', '\x2', '\xB5', '\xB6', '\x3', 
		'\x2', '\x2', '\x2', '\xB6', '\xB4', '\x3', '\x2', '\x2', '\x2', '\xB6', 
		'\xB7', '\x3', '\x2', '\x2', '\x2', '\xB7', '\x1F', '\x3', '\x2', '\x2', 
		'\x2', '\xB8', '\xBE', '\a', '(', '\x2', '\x2', '\xB9', '\xBE', '\a', 
		'%', '\x2', '\x2', '\xBA', '\xBB', '\a', '$', '\x2', '\x2', '\xBB', '\xBC', 
		'\a', ')', '\x2', '\x2', '\xBC', '\xBE', '\a', '*', '\x2', '\x2', '\xBD', 
		'\xB8', '\x3', '\x2', '\x2', '\x2', '\xBD', '\xB9', '\x3', '\x2', '\x2', 
		'\x2', '\xBD', '\xBA', '\x3', '\x2', '\x2', '\x2', '\xBE', '!', '\x3', 
		'\x2', '\x2', '\x2', '\xBF', '\xC0', '\a', '\x5', '\x2', '\x2', '\xC0', 
		'\xC4', '\a', '\x10', '\x2', '\x2', '\xC1', '\xC3', '\x5', '$', '\x13', 
		...
		'\b', '\x2', '\x2', '\xC8', '\xD7', '\a', '\x14', '\x2', '\x2', '\xC9', 
		'\xCA', '\a', '\n', '\x2', '\x2', '\xCA', '\xD7', '\a', '\x10', '\x2', 
		'\x2', '\xCB', '\xCC', '\a', '\a', '\x2', '\x2', '\xCC', '\xD1', '\a', 
		'\x10', '\x2', '\x2', '\xCD', '\xCE', '\a', '\f', '\x2', '\x2', '\xCE', 
		'\xD0', '\a', '\x10', '\x2', '\x2', '\xCF', '\xCD', '\x3', '\x2', '\x2', 
		'\x2', '\xD0', '\xD3', '\x3', '\x2', '\x2', '\x2', '\xD1', '\xCF', '\x3', 
		'\x2', '\x2', '\x2', '\xD1', '\xD2', '\x3', '\x2', '\x2', '\x2', '\xD2', 
		'\xD7', '\x3', '\x2', '\x2', '\x2', '\xD3', '\xD1', '\x3', '\x2', '\x2', 
		'\x2', '\xD4', '\xD7', '\x5', '\x10', '\t', '\x2', '\xD5', '\xD7', '\x5', 
		'&', '\x14', '\x2', '\xD6', '\xC7', '\x3', '\x2', '\x2', '\x2', '\xD6', 
		'\xC9', '\x3', '\x2', '\x2', '\x2', '\xD6', '\xCB', '\x3', '\x2', '\x2', 
		'\x2', '\xD6', '\xD4', '\x3', '\x2', '\x2', '\x2', '\xD6', '\xD5', '\x3', 
		'\x2', '\x2', '\x2', '\xD7', '%', '\x3', '\x2', '\x2', '\x2', '\xD8', 
		'\xD9', '\x5', '(', '\x15', '\x2', '\xD9', '\xDE', '\x5', '\x18', '\r', 
		'\x2', '\xDA', '\xDB', '\a', '\x13', '\x2', '\x2', '\xDB', '\xDD', '\x5', 
		'\x18', '\r', '\x2', '\xDC', '\xDA', '\x3', '\x2', '\x2', '\x2', '\xDD', 
		'\xE0', '\x3', '\x2', '\x2', '\x2', '\xDE', '\xDC', '\x3', '\x2', '\x2', 
		'\x2', '\xDE', '\xDF', '\x3', '\x2', '\x2', '\x2', '\xDF', '\'', '\x3', 
		'\x2', '\x2', '\x2', '\xE0', '\xDE', '\x3', '\x2', '\x2', '\x2', '\xE1', 
		'\xE3', '\a', '\v', '\x2', '\x2', '\xE2', '\xE4', '\a', '\x33', '\x2', 
		'\x2', '\xE3', '\xE2', '\x3', '\x2', '\x2', '\x2', '\xE3', '\xE4', '\x3', 
		'\x2', '\x2', '\x2', '\xE4', '\xE5', '\x3', '\x2', '\x2', '\x2', '\xE5', 
		'\xE6', '\x5', '*', '\x16', '\x2', '\xE6', '\xE7', '\a', '\x32', '\x2', 
		'\x2', '\xE7', ')', '\x3', '\x2', '\x2', '\x2', '\xE8', '\xEA', '\a', 
		'+', '\x2', '\x2', '\xE9', '\xEB', '\a', '\x33', '\x2', '\x2', '\xEA', 
		'\xE9', '\x3', '\x2', '\x2', '\x2', '\xEA', '\xEB', '\x3', '\x2', '\x2', 
		'\x2', '\xEB', '\xEC', '\x3', '\x2', '\x2', '\x2', '\xEC', '\xF8', '\x5', 
		',', '\x17', '\x2', '\xED', '\xEF', '\a', ',', '\x2', '\x2', '\xEE', '\xF0', 
		'\a', '\x33', '\x2', '\x2', '\xEF', '\xEE', '\x3', '\x2', '\x2', '\x2', 
		'\xEF', '\xF0', '\x3', '\x2', '\x2', '\x2', '\xF0', '\xF1', '\x3', '\x2', 
		'\x2', '\x2', '\xF1', '\xF8', '\x5', ',', '\x17', '\x2', '\xF2', '\xF4', 
		'\a', '-', '\x2', '\x2', '\xF3', '\xF5', '\a', '\x33', '\x2', '\x2', '\xF4', 
		'\xF3', '\x3', '\x2', '\x2', '\x2', '\xF4', '\xF5', '\x3', '\x2', '\x2', 
		'\x2', '\xF5', '\xF6', '\x3', '\x2', '\x2', '\x2', '\xF6', '\xF8', '\x5', 
		',', '\x17', '\x2', '\xF7', '\xE8', '\x3', '\x2', '\x2', '\x2', '\xF7', 
		'\xED', '\x3', '\x2', '\x2', '\x2', '\xF7', '\xF2', '\x3', '\x2', '\x2', 
		'\x2', '\xF8', '+', '\x3', '\x2', '\x2', '\x2', '\xF9', '\xFB', '\x5', 
		'.', '\x18', '\x2', '\xFA', '\xF9', '\x3', '\x2', '\x2', '\x2', '\xFB', 
		'\xFC', '\x3', '\x2', '\x2', '\x2', '\xFC', '\xFA', '\x3', '\x2', '\x2', 
		'\x2', '\xFC', '\xFD', '\x3', '\x2', '\x2', '\x2', '\xFD', '-', '\x3', 
		'\x2', '\x2', '\x2', '\xFE', '\xFF', '\a', '\x30', '\x2', '\x2', '\xFF', 
		'\x100', '\x5', '\x30', '\x19', '\x2', '\x100', '\x101', '\a', '\x31', 
		'\x2', '\x2', '\x101', '\x104', '\x3', '\x2', '\x2', '\x2', '\x102', '\x104', 
		'\x5', '\x36', '\x1C', '\x2', '\x103', '\xFE', '\x3', '\x2', '\x2', '\x2', 
		'\x103', '\x102', '\x3', '\x2', '\x2', '\x2', '\x104', '/', '\x3', '\x2', 
		'\x2', '\x2', '\x105', '\x108', '\x5', '\x32', '\x1A', '\x2', '\x106', 
		'\x107', '\a', '\x34', '\x2', '\x2', '\x107', '\x109', '\x5', '\x34', 
		'\x1B', '\x2', '\x108', '\x106', '\x3', '\x2', '\x2', '\x2', '\x108', 
		'\x109', '\x3', '\x2', '\x2', '\x2', '\x109', '\x31', '\x3', '\x2', '\x2', 
		'\x2', '\x10A', '\x10B', '\a', '\x36', '\x2', '\x2', '\x10B', '\x33', 
		'\x3', '\x2', '\x2', '\x2', '\x10C', '\x10D', '\a', '\x36', '\x2', '\x2', 
		'\x10D', '\x35', '\x3', '\x2', '\x2', '\x2', '\x10E', '\x114', '\t', '\x2', 
		'\x2', '\x2', '\x10F', '\x114', '\a', '\x35', '\x2', '\x2', '\x110', '\x114', 
		'\t', '\x3', '\x2', '\x2', '\x111', '\x114', '\a', '\x33', '\x2', '\x2', 
		'\x112', '\x114', '\a', '\x34', '\x2', '\x2', '\x113', '\x10E', '\x3', 
		'\x2', '\x2', '\x2', '\x113', '\x10F', '\x3', '\x2', '\x2', '\x2', '\x113', 
		'\x110', '\x3', '\x2', '\x2', '\x2', '\x113', '\x111', '\x3', '\x2', '\x2', 
		'\x2', '\x113', '\x112', '\x3', '\x2', '\x2', '\x2', '\x114', '\x37', 
		'\x3', '\x2', '\x2', '\x2', ' ', ';', '\x43', 'J', 'U', 'Z', '\x61', 'i', 
		'p', 'v', '{', '\x84', '\x8C', '\x92', '\x9B', '\xB1', '\xB6', '\xBD', 
		'\xC4', '\xD1', '\xD6', '\xDE', '\xE3', '\xEA', '\xEF', '\xF4', '\xF7', 
		'\xFC', '\x103', '\x108', '\x113',
	};
