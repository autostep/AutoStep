...
namespace AutoStep.Language.Test
{
    ...
    internal static class ParserDiagnosticExtensions
    {
        ...
        {
            var listener = new AutoStepParserDebugListener(parser);
        ...
        private class AutoStepParserDebugListener : AutoStepParserBaseListener
        {
            private readonly StringBuilder output;
            private readonly AutoStepParser parser;
            private int indendation = 0;

            public AutoStepParserDebugListener(AutoStepParser parser)
            {
